...
namespace MISA.WEBAPI.API.Controllers
{
    ...
    public class ProductsController : MISABaseController<Product>
    {
        ...
        public ProductsController(IBaseService<Product> baseService, IBaseInfrastructure<Product> baseInfrastructure) : base(baseService, baseInfrastructure)
        {
        }
